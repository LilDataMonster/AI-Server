...
from api.data import tesseract, yolov5, legos
# import cv2
...
class LegoUploadImageView(APIView):
    ...
    def post(self, request, format=None):
        ...
        data_response, output_images = legos.detect(images)
        ...
        # cv2.imwrite(tmpfile, first_image, [int(cv2.IMWRITE_JPEG_QUALITY), 100])
        tmpfile.seek(0)
...
class LegoUploadMetadataView(APIView):
    parser_classes = (ImageUploadParser,)
